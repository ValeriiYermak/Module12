...
його email, телефонний номер phone та властивість favorite - обраний контакт
чи ні.
...
використовуючи метод dump пакету pickle. Ім'я файлу зберігається в атрибуті
filename.
...
class Contacts(Person):
    ...
    def save_to_file(self):
        with open(self.filename, "wb", encoding="utf-8", newline="") as file:
